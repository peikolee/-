...
conn = sqlite3.connect('C:/backup/毕业设计/基于机器学习的社交媒体抑郁情绪分析系统/Sentiment-Analysis-and-Emotional-Intelligence-in-Social-Media-with-AI-Data/data.db', check_same_thread=False)
c = conn.cursor()
